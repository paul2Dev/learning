             ...
             <div class="table-responsive">
               <table class="table align-middle mb-0">
                <thead class="table-light">
                 ...
                 <tbody><tr>
                  <td>Iphone 5</td>
                  <td><img src="{{ asset('backend/assets/images/products/18.png') }}" class="product-img-2" alt="product img"></td>
                  <td>#9405822</td>
                 ...
                 <tr>
                  <td>Earphone GL</td>
                  <td><img src="{{ asset('backend/assets/images/products/16.png') }}" class="product-img-2" alt="product img"></td>
                  <td>#8304620</td>
                 ...
                 <tr>
                  ...
                  <td><img src="{{ asset('backend/assets/images/products/19.png') }}" class="product-img-2" alt="product img"></td>
                  <td>#4736890</td>
                 ...
                 <tr>
                  <td>Sitting Chair</td>
                  <td><img src="{{ asset('backend/assets/images/products/11.png') }}" class="product-img-2" alt="product img"></td>
                  <td>#9629240</td>
                  <td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span></td>
                  <td>$1500.00</td>
                  <td>18 Feb 2020</td>
                 ...
                 <tr>
                  <td>Hand Watch</td>
                  <td><img src="{{ asset('backend/assets/images/products/17.png') }}" class="product-img-2" alt="product img"></td>
                  <td>#8506790</td>
                  <td><span class="badge bg-gradient-bloody text-white shadow-sm w-100">Failed</span></td>
                  <td>$1800.00</td>
                  <td>21 Feb 2020</td>
