        ...
        <div class="row pt-50px">
            <div class="col-lg-10 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        <form method="post" method="POST" action="{{ route('instructor.register') }}" class="row">
                            @csrf
                            <div class="input-box col-lg-6">
                                <label class="label-text">Name</label>
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-invalid @enderror" type="text" name="name">
                                    <span class="la la-clipboard-list input-icon"></span>
                                    @error('name')
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="la la-mail-bulk input-icon"></span>
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="input-box col-lg-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('password') is-invalid @enderror" type="password" name="password">
                                    <span class="la la-user input-icon"></span>
                                    @error('password')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
