                        ...
                        <form method="POST" action="{{ route('register') }}" class="pt-4">
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Name" required>
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" name="email" id="email" value="{{ old('email') }}" placeholder="Enter email address" required>
                            ...
                            <div class="input-box">
                                ...
                                <div class="input-group mb-3">
                                    <span class="la la-lock input-icon"></span>
                                    <input class="form-control form--control password-confirmation-field" type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm Password" required>
                                </div>
                            </div><!-- end input-box -->
                            <div class="btn-box">
